# Generated by Django 2.1.3 on 2019-01-29 21:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(max_length=26, null=True, verbose_name='API密钥')),
        ...
        migrations.AddField(
            model_name='device',
            name='users',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='device_users', to='SqlMaster.Users', verbose_name='所属用户'),
        ),
        migrations.AddField(
            model_name='data',
            name='name',
